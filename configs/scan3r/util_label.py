...
import numpy as np
import trimesh
from configs.scan3r import define

def read_pointcloud_R3SCAN(scan_pth):
    """
    Reads a pointcloud and returns points with instance label.
    """
    plydata = trimesh.load(scan_pth, process=False)
