...
from spt.utils.hydra import init_config
from spt.utils.neighbors import knn_2
from spt.utils.graph import to_trimmed
from spt.utils.cpu import available_cpu_count
from spt.utils.scatter import scatter_mean_weighted
from spt.utils.semantic import _set_attribute_preserving_transforms
...
def generate_random_bbox_data(
    ...
    from spt.data.instance import InstanceData
...
def oracle_superpoint_clustering(
    ...
    from spt.transforms import OnTheFlyInstanceGraph
