...
import spt
from spt.data.cluster import CSRData
from spt.data.cluster import Cluster
...
from spt.utils import tensor_idx, is_dense, has_duplicates, \
...
class Data(PyGData):
    ...
    def select(
        ...
        for key, item in self:
            ...
            # can skip them here
            if key in warn_keys and spt.is_debug_enabled():
                print(
    ...
    def show(self, **kwargs):
        ...
        from spt.visualization import show
